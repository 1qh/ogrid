...
import { Brush, CartesianGrid, Line, LineChart, ReferenceArea, ReferenceDot, ReferenceLine, ResponsiveContainer, XAxis, YAxis } from 'recharts'
const data = [
  ...
  LineChartWidget = () => (
    <div className='flex h-full flex-col gap-2'>
      ...
      <span className='text-xs text-muted-foreground'>3 metrics with target zones, reference points, and brush</span>
